...
class Controller:
    ...
    def add_drug(self):
        try:
            ...
            self.model.insert_drug(name, price, quantity, form_id, producer_id)
    ...
    def add_producer(self):
        try:
            ...
            self.model.insert_producer(name, address, link, phone_number)
    ...
    def add_drug_group(self):
        try:
            ...
            self.model.insert_drug_group(drug_id, group_id)
    ...
    def show_producers(self):
        try:
            producers = self.model.show_producers()
    ...
    def show_groups(self):
        try:
            groups = self.model.show_groups()
            self.view.show_groups(groups)
        except Exception as e:
            self.view.show_message(f"Something went wrong: {e}")

    def show_drugs_groups(self):
        try:
            drugs_groups = self.model.show_drugs_groups()
